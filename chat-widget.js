...
- خطة تسويقية AI: 200 ريال
- سيرة ذاتية AI: 50 ريال
...
👉 moehabads.com/plan`,
      service: { name: 'خطة تسويقية AI', price: '200 ريال' }
    },
  ];
  ...
  async function moHandleMsg(text) {
    ...
    try {
      ...
      const serviceMap = [
        ...
        { keys: ['خطة','plan'], name: 'خطة تسويقية AI', price: '200 ريال' },
      ];
